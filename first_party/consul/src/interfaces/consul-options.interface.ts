...
namespace Agent {
  ...
  export interface Service {
    ...
    maintenance: {
      <TData>(
        opts: Service.MaintenanceOptions,
...
export interface ConsulEvent {
  ...
  fire: {
    ...
    <TData>(name: string, callback: Callback<TData>): void;
    <TData>(opts: FireOptions, callback: Callback<TData>): void;
    <TData>(name: string, payload: string | Buffer): Thenable<TData>;
    <TData>(name: string): Thenable<TData>;
    <TData>(opts: FireOptions): Thenable<TData>;
  };
  ...
  list: {
    <TData>(name: string, callback: Callback<TData>): void;
    <TData>(opts: ListOptions, callback: Callback<TData>): void;
    <TData>(callback: Callback<TData>): void;
    <TData>(name?: string): Thenable<TData>;
    <TData>(opts?: ListOptions): Thenable<TData>;
  };
}
...
export interface ConsulLock extends NodeJS.EventEmitter {
  consul: IConsul;
...
export interface LockStatic {
  new (consul: IConsul, opts: Options): Lock;
}
