...
export default function InvitationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>{serviceName} Verification</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                {account ? `Hi, ${account} ` : ''}Thanks for using the{' '}
                {serviceName} service. We want to make sure it's really you.
